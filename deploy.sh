...
ssh master "hdfs dfs -put -f elasticsearch-mesos-executor.jar /elasticsearch-mesos"
...
ssh master "hdfs dfs -put -f elasticsearch-cloud-mesos.zip /elasticsearch-mesos"
